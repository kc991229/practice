...
class Binary
{
    public:
        ...
        void BinaryTree_OrderTraver(Node* root )
        {
            stack<Node*> st;//定义一个栈
        ...
        void BinaryTree_middleTraver(Node* root)
        {
            stack<Node*> st;
            Node* cur = root;
            while (cur || !st.empty())
        ...
        void BinaryTree_LastTraver(Node* root)
        {
            stack<Node*> st;
            Node* cur = root;
            Node* prev = nullptr;
        ...
        void BinaryTree_OrderTraver_recursion(Node* root)
        {
            Node* cur = root;
            if(cur != nullptr)
            {
        ...
        void BinaryTree_middleTraver_recursion(Node* root)
        {
            Node* cur = root;
            if(cur != nullptr)
            {
        ...
        void BinaryTree_LastTraver_recursion(Node* root)
        {
            Node* cur = root;
            if(cur != nullptr)
            {
